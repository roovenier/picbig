				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							...
							<Picbig className="pb1" small="/src/images/image1_s.jpg" big="/src/images/image1_b.jpg" title="Star Wars" />
							...
							<Picbig className="pb2" small="/src/images/image2_s.jpg" big="/src/images/image2_b.jpg" />
							...
							<div className="pb-container">
								<Picbig className="pb3" group="gallery" small="/src/images/image3_s.jpg" big="/src/images/image3_b.jpg" />

								<Picbig className="pb5" group="gallery" small="/src/images/image5_s.jpg" big="/src/images/image5_b.jpg" title="Booker Dewitt" />

								<Picbig className="pb4" group="gallery" small="/src/images/image4_s.jpg" big="/src/images/image4_b.jpg" title="Last of Us art" />
							</div>
